...
def args_parse():
    ...
    parser.add_argument('--epoch-times',default=2, type=int,help='The training times of the model.')
    parser.add_argument('--min-count',default=5, type=int, help='The word min count.')
    parser.add_argument('--batch-size',default=32, type=int, help='Batch size for training dataset.')
